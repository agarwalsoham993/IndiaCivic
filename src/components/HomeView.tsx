        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="space-y-3">
            <div className="relative">
              ...
              />
              <button className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 cursor-pointer bg-transparent border-none">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap snap-start transition-all cursor-pointer ${
                    selectedCategory === cat 
                      ...
                      : "bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 hover:text-slate-700 dark:hover:text-slate-200 animate-none"
                  }`}
                >
                  {cat}
                </button>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button className="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 flex items-center space-x-1 cursor-pointer bg-transparent border-none">
                <span>VIEW ALL</span>
          ...
          >
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex items-baseline mt-1.5">
                  <span className="text-4xl font-extrabold text-slate-800 dark:text-slate-100 tracking-tight">B+</span>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-[200px] font-medium leading-relaxed">Based on 92% resolution speed, low active issues, and standard safety metrics.</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
              <div className="bg-slate-50 dark:bg-slate-850/60 rounded-xl p-2.5 border border-slate-200/60 dark:border-slate-800">
                ...
                <div className="text-lg font-bold text-slate-700 dark:text-slate-200 mt-0.5">3 Ward Reports</div>
              </div>
              <div className="bg-slate-50 dark:bg-slate-850/60 rounded-xl p-2.5 border border-slate-200/60 dark:border-slate-800">
                <div className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase">YOUR ACTIVE RANK</div>
                <div className="text-lg font-bold text-slate-700 dark:text-slate-200 mt-0.5 font-sans">#12 in Ward 88</div>
              </div>
            </div>
          </motion.div>
