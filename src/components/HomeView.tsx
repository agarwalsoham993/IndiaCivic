        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <div className="text-base font-bold text-slate-800 flex items-center">
              ...
              <span className="ml-1.5 px-2 py-0.5 text-[10px] bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100">Ward 88</span>
            </div>
          </div>
        </div>
        <div className="flex items-center space-x-2">
          {/* Notifications */}
          <button className="relative p-2.5 rounded-xl bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer">
      ...
      {user.id === "guest" && (
        ...
        >
          ...
          <button 
            ...
            className="mt-3 px-4 py-1.5 bg-white text-indigo-600 hover:text-indigo-700 hover:bg-slate-50 font-extrabold text-[10px] uppercase rounded-xl transition-all cursor-pointer shadow-sm"
          >
            Create Your Account
          </button>
        </motion.div>
      ...
      >
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-[200px]">Based on 92% resolution speed, low active issues, and standard safety metrics.</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-slate-100">
          ...
          <div className="bg-slate-50 rounded-xl p-2.5 border border-slate-200/60">
            ...
            <div className="text-lg font-bold text-slate-700 mt-0.5">#12 in Ward 88</div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-2xl bg-white border border-slate-200 p-4 flex items-center space-x-3 shadow-sm">
          ...
          <div>
            ...
            <div className="text-base font-extrabold text-slate-700">{user.streakDays} Days Daily Action</div>
          </div>
        </div>
        <div className="rounded-2xl bg-white border border-slate-200 p-4 flex items-center space-x-3 shadow-sm">
          <div className="p-2.5 rounded-xl bg-indigo-50 border border-indigo-100">
          ...
          <div>
            ...
            <div className="text-base font-extrabold text-indigo-700">{user.totalPoints} pts</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-10 py-3 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-500/20 shadow-sm transition-all"
          />
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-extrabold text-slate-800 tracking-wider uppercase flex items-center">
            ...
            <span className="ml-2 px-2 py-0.5 text-[10px] font-bold bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100">
        ...
        {filteredIssues.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredIssues.map((issue) => (
              ...
              >
                <div className="p-4 cursor-pointer" onClick={() => onSelectIssue(issue)}>
                  <div className="flex justify-between items-start">
                    <div className="flex items-center space-x-2">
                      <span className="px-2 py-0.5 text-[9px] font-bold tracking-widest bg-slate-100 text-slate-600 rounded-md border border-slate-200 uppercase">
                        {issue.category}
                      </span>
                ...
                <div className="flex items-center justify-between px-4 py-3 bg-slate-50 border-t border-slate-100 text-xs text-slate-500">
                  <div className="flex items-center space-x-4">
                    ...
                    >
                      ...
                      <span className="font-extrabold text-slate-700">{issue.corroborations.length}</span>
                    </button>
